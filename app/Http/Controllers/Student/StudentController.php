...
class StudentController extends Controller
{
    ...
    public function createPreRegistiration()
    {
        ...
        return view('admin.students.createPreRegistiration', compact('classes', 'education_levels'));
    }

    public function storePreRegistiration(Request $request)
    {
    ...
    public function preToNormalPost(Request $request, $id)
    {
