...
@section('page-banner')
    <div class="w-full">
        <div class="flex items-center gap-3">
            ...
            <div class="min-w-0">
                <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Yeni Blog Kategorisi</h1>
                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Yeni bir blog kategorisi ekleyin</p>
            </div>
        </div>
    </div>
@endsection
