...
@section('page-banner')
    <div class="w-full">
        <div class="flex items-center gap-3">
            <x-back-button :href="route('blogs.index')" />
            <div class="min-w-0">
        ...
        <div class="lg:col-span-2 space-y-5">
            ...
            <div class="relative bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200/50 dark:border-slate-700/50">
                ...
                <div class="relative p-6 space-y-5">
                    ...
                    <x-textarea name="content" label="İçerik" placeholder="Blog yazısının içeriği..." rows="10" :value="$blog->content" inputClass="tinymce-editor" data-upload-url="{{ route('blogs.uploadImage') }}" />
