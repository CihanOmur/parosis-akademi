...
@section('page-banner')
    <div class="w-full">
        <div class="flex items-center gap-3">
            <x-back-button :href="route('blogTags.index')" />
            <div class="min-w-0">
                <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Yeni Blog Etiketi</h1>
                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Yeni bir blog etiketi ekleyin</p>
            </div>
        </div>
    </div>
@endsection
            ...
            <div class="relative bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200/50 dark:border-slate-700/50 overflow-hidden">
                ...
                <div class="relative flex items-center gap-3 px-6 pt-6 pb-4 border-b border-slate-100 dark:border-slate-700/50">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-400 mt-0.5">Varsayılan dilde etiket adını yazın</p>
                    </div>
                </div>

                <div class="relative p-6 space-y-5">
                    <x-text-input name="name" label="Ad" placeholder="Etiket adını yazın..." required />
                </div>
            </div>
        </div>
                ...
                <div class="flex gap-3">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <p class="text-xs text-amber-700 dark:text-amber-500">
                            Etiket adı varsayılan dilde kaydedilir. Diğer dillerdeki çevirilerini düzenleme sayfasından ekleyebilirsiniz.
                        </p>
                    </div>
                </div>
            </div>
