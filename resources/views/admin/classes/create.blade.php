...
@section('page-banner')
    <div class="w-full">
        <div class="flex items-center gap-3">
            <x-back-button :href="route('class.index')" />
            <div class="min-w-0">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200/50 dark:border-slate-700/50 shadow-sm overflow-hidden">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <x-text-input name="quota" type="number" label="Kontenjan" placeholder="15" suffix="kişi" required min="1" />
                        <x-text-input name="course_time" label="Kurs Süresi" placeholder="Örn: 3 Ay / 48 Saat" required />
                    </div>

                    {{-- Başlangıç + Bitiş Tarihi --}}
                    <div class="grid grid-cols-2 gap-4">
                        <x-text-input name="start_date" type="date" label="Başlangıç Tarihi" required />
                        <x-text-input name="end_date" type="date" label="Bitiş Tarihi" required />
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200/50 dark:border-slate-700/50 shadow-sm">
                ...
                <div class="p-6">
                    ...
                    <x-checkbox-dropdown
                        ...
                        :selected="old('teacher_id') ? [(int) old('teacher_id')] : []"
            ...
            <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200/50 dark:border-slate-700/50 shadow-sm">
                ...
                <div class="p-6">
                    ...
                    <x-checkbox-dropdown
                        ...
                        :selected="old('course_id') ? [(int) old('course_id')] : []"
