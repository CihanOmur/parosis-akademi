...
@section('page-banner')
    <div class="w-full">
        <div class="flex items-center gap-3">
            <x-back-button :href="route('courseCategories.edit', $category->id)" />
            <div class="min-w-0">
...
@section('content')
<form action="{{ route('courseCategories.updateTranslate', $category->id) }}" method="POST">
    @csrf
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-5 sticky top-24 self-start">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200/50 dark:border-slate-700/50 p-5 space-y-3">
                ...
                <a href="{{ route('courseCategories.edit', $category->id) }}"
                   class="w-full inline-flex items-center justify-center gap-2 px-5 py-3
