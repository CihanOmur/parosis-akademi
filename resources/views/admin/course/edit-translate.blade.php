                ...
                <div class="relative p-6 space-y-5">
                    <div class="space-y-1">
                        ...
                        <input type="text" name="title" id="title"
                               ...
                               value="{{ old('title', $course->getTranslation('title', $selectedLang, false)) }}" required>
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <textarea name="short_description" id="short_description" rows="3"
                                  ...
                                  placeholder="Kısa açıklamanın çevirisini yazın...">{{ old('short_description', $course->getTranslation('short_description', $selectedLang, false)) }}</textarea>
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <textarea name="content" id="content" rows="10"
                                  class="w-full px-4 py-3 bg-slate-50 dark:bg-slate-700/70 border-0 rounded-xl
                                         text-slate-900 dark:text-white placeholder-slate-400 text-sm
                                         ring-1 ring-slate-200 dark:ring-slate-600 focus:ring-2 focus:ring-blue-500/60 transition-all resize-y"
                                  placeholder="İçeriğin çevirisini yazın...">{{ old('content', $course->getTranslation('content', $selectedLang, false)) }}</textarea>
                    </div>
