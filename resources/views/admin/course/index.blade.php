                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-1">
                                    ...
                                    <div class="relative" x-data="{ open: false }">
                                        ...
                                        <div x-show="open" @click.away="open = false"
                                            ...
                                            @foreach ($activeLanguages as $activeLang)
                                                <a href="{{ route('courses.editTranslate', ['id' => $item->id, 'lang' => $activeLang->locale]) }}"
                                    ...
                                    <form action="{{ route('courses.delete', $item->id) }}" method="POST"
                                          x-data @submit.prevent="$dispatch('confirm-dialog', { title: 'Kursu Sil', message: 'Bu kursu silmek istediğinize emin misiniz?', form: $el })">
                                        @csrf
                                        @method('DELETE')
