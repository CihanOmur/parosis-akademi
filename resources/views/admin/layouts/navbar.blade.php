            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center">
                    ...
                    <div id="avatarButton" type="button" data-dropdown-toggle="userDropdown"
                        ...
                        class="w-10 h-10 rounded-full cursor-pointer relative inline-flex items-center justify-center overflow-hidden bg-gray-600 ">
                    ...
                    <!-- Dropdown menu -->
                    <div id="userDropdown"
                        class="z-10 hidden bg-white divide-y divide-gray-200 rounded-lg border border-gray-200 shadow-sm w-44">
                        ...
                        <div class="py-1">
                            ...
                            <a href="#" onclick="document.getElementById('logout').submit();" role="menuitem"
