...
@section('content')
    <div class="rounded-lg mb-4">
        ...
        <div class="w-full bg-white py-10 px-8 rounded-lg">
            <form class="lg:w-1/2 w-full" action="{{ route('pages.update', ['id' => 'contact']) }}" method="POST"
                ...
                <div class="mb-6">
                    <label for="form_title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Form
                        Başlık</label>
                ...
                <div class="mb-6">
                    <label for="form_description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Form
                        Açıklama</label>
