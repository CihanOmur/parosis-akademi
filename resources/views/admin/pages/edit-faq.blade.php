                ...
                <div style="padding: 60px 0;">
                    <div style="max-width: 1200px; margin: 0 auto; padding: 0 1.25rem;">
                        <div style="text-align: center;">
                            <div class="ez" :class="activeField === 'title' && 'ez-active'" data-label="Düzenle" @click.stop="openModal('title', 'Sayfa Başlığı', 'textarea')">
...
<script>
    function faqEditor() {
        return {
            ...
            fields: {
                cta_enabled: @json((bool) ($faqPageInfo->cta_enabled ?? true)),
                breadcrumb_bg_color: @json($faqPageInfo->breadcrumb_bg_color ?? ''),
                breadcrumb_bg_image: @json($faqPageInfo->breadcrumb_bg_image ?? ''),
