    ...
    <div class="rounded-lg mb-4">
        ...
        <div class="w-full bg-white py-10 px-8 rounded-lg">
            <form class="lg:w-1/2 w-full" action="{{ route('pages.update', ['id' => 'services']) }}" method="POST"
                ...
                <div class="mb-6">
                    <label for="info_title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Info
                        Başlık</label>
                ...
                <div class="mb-6">
                    <label for="info_subtitle" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Info Alt
                        Başlık</label>
                ...
                <div class="mb-6">
                    <label for="info_content" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Info
                        Açıklama</label>
                ...
                <div class="mb-6">
                    <label for="info_skil_column_1"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Info Özellik 1</label>
                ...
                <div class="mb-6">
                    <label for="info_skil_column_2"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Info Özellik 2</label>
                ...
                <div class="mb-6">
                    <label for="info_skil_column_3"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Info Özellik 3</label>
                ...
                <div class="mb-6">
                    <label for="faq_title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">SSS
                        Başlık</label>
                ...
                <div class="mb-6">
                    <label for="faqs" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">SSS
                        Seçiniz</label>
