...
@section('page-banner')
    <div class="w-full">
        <div class="flex items-center gap-3">
            <x-back-button :href="route('productAttributes.index')" />
            <div class="min-w-0">
                <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Yeni Ürün Niteliği</h1>
                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Yeni bir ürün niteliği oluşturun</p>
            </div>
        </div>
    </div>
@endsection
            ...
            <div class="relative bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200/50 dark:border-slate-700/50 overflow-hidden">
                ...
                <div class="relative flex items-center gap-3 px-6 pt-6 pb-4 border-b border-slate-100 dark:border-slate-700/50">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-400 mt-0.5">Varsayılan dilde nitelik adını yazın</p>
                    </div>
                </div>

                <div class="relative p-6">
                    <x-text-input name="name" label="Nitelik Adı" placeholder="ör: Beden, Renk" required />
                </div>
            </div>
        </div>
                ...
                <div class="flex gap-3">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <p class="text-xs text-amber-700 dark:text-amber-500">
                            Nitelik adı varsayılan dilde kaydedilir. Kaydettikten sonra düzenleme sayfasından değerler (ör: S, M, L veya Kırmızı, Mavi) ekleyebilirsiniz.
                        </p>
                    </div>
                </div>
            </div>
