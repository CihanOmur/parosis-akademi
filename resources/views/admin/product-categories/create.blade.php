...
@section('page-banner')
    <div class="w-full">
        <div class="flex items-center gap-3">
            ...
            <div class="min-w-0">
                <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Yeni Ürün Kategorisi</h1>
                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Yeni bir ürün kategorisi ekleyin</p>
            </div>
        </div>
    </div>
@endsection
            ...
            <div class="relative bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200/50 dark:border-slate-700/50 overflow-hidden">
                ...
                <div class="relative p-6 space-y-5">
                    ...
                    <div class="space-y-1">
                        ...
                        <x-image-upload name="image" uploadPath="product-categories" />
                    </div>
                </div>
            </div>
        </div>
