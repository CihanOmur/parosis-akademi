    ...
    <div class="w-full">
        <div class="flex items-center gap-3">
            ...
            <div class="min-w-0">
                ...
                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400"><span class="font-semibold text-fuchsia-600 dark:text-fuchsia-400">{{ $role->name }}</span> rolünü düzenleyin</p>
            </div>
        </div>
    </div>
@endsection
