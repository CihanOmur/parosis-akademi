...
@section('page-banner')
    <div class="w-full">
        <div class="flex items-center gap-3">
            <x-back-button :href="route('sliders.items.index', $slider->id)" />
            <div class="min-w-0">
                <h1 class="text-2xl font-bold text-slate-900 dark:text-white">Yeni Slayt Ekle</h1>
...
@section('content')
<form action="{{ route('sliders.items.store', $slider->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
            ...
            <div class="relative bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200/50 dark:border-slate-700/50 overflow-hidden">
                ...
                <div class="relative flex items-center gap-3 px-6 pt-6 pb-4 border-b border-slate-100 dark:border-slate-700/50">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-400 mt-0.5">Slayt metin bilgilerini girin</p>
                    </div>
                </div>
                ...
                <div class="relative p-6 space-y-5">
                    ...
                    <div class="space-y-1">
                        ...
                        <textarea name="description" id="description" rows="3"
                                  ...
                                  placeholder="Kısa açıklama yazın">{{ old('description') }}</textarea>
                        @error('description')
            ...
            <div class="relative bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200/50 dark:border-slate-700/50 overflow-hidden">
                ...
                <div class="relative flex items-center gap-3 px-6 pt-6 pb-4 border-b border-slate-100 dark:border-slate-700/50">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-400 mt-0.5">Slayt görsellerini yükleyin</p>
                    </div>
                </div>
                ...
                <div class="relative p-6 space-y-5">
                    ...
                    <div class="space-y-1">
                        ...
                        <x-image-upload name="image" hint="Hero bölümünde ön planda görünen resim. PNG önerilir. Maks 5MB." />
                    </div>
                    ...
                    <div class="space-y-1">
                        ...
                        <x-image-upload name="background_image" hint="Hero bölümünde arka planda kullanılacak resim/desen. SVG veya PNG. Maks 5MB." />
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="flex gap-3">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <p class="text-xs text-amber-700 dark:text-amber-500">
                            Metin alanları varsayılan dilde kaydedilir. Çevirileri düzenleme sayfasından ekleyebilirsiniz.
                        </p>
                    </div>
                </div>
            </div>
