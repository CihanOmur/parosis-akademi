        ...
        <div class="lg:col-span-2 space-y-5">
            ...
            <div class="relative bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200/50 dark:border-slate-700/50 overflow-hidden">
                ...
                <div class="relative p-6 space-y-5">
                    {{-- Başlık --}}
                    <x-text-input name="title" label="Başlık" placeholder="Slayt başlığını yazın" :value="$item->getTranslation('title', app()->getLocale(), false)" required />

                    {{-- Vurgulu Metin --}}
                    <x-text-input name="highlight_text" label="Vurgulu Metin" placeholder="Vurgulu kelime (ör: Online)" :value="$item->getTranslation('highlight_text', app()->getLocale(), false)" />
                    ...
                    {{-- Buton Metni --}}
                    <x-text-input name="button_text" label="Buton Metni" placeholder="Buton metni (ör: Tüm Kursları Görüntüle)" :value="$item->getTranslation('button_text', app()->getLocale(), false)" />

                    {{-- Buton Linki --}}
                    <x-text-input name="button_url" label="Buton Linki" placeholder="Buton linki (ör: /kurslar)" :value="$item->button_url" />
                </div>
            </div>
