                                ...
                                <div>
                                    ...
                                    <div class="grid grid-cols-4 gap-4">
                                        ...
                                        <div class="mb-6">
                                            ...
                                            <select name="guardian1_education_level"
                                                ...
                                                @foreach ($education_levels as $level)
                                                    <option
                                                        {{ old('guardian1_education_level') == $level ? 'selected' : '' }}
                                        ...
                                        <div class="mb-6">
                                            ...
                                            <input type="email" name="guardian1_email"
                                                placeholder="örn: ornek@parosis.com"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                    ...
                                    <div>
                                        ...
                                        <div id="guardian2_fields" class="grid grid-cols-4 gap-4">
                                            <div class="mb-6">
                                                <label class="block mb-2 font-medium">Yakınlık</label>
                                                <input type="text" name="guardian2_relationship"
                                                    placeholder="örn: Baba" disabled
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                            ...
                                            <div class="mb-6">
                                                ...
                                                <input type="date" name="guardian1_birth_date"
                                                    placeholder="Doğum Tarihi" disabled
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                                    value="{{ old('guardian1_birth_date') }}">
                                                <div class="text-red-500 text-xs mt-2">
                                                    @error('guardian1_birth_date')
                                            ...
                                            <div class="mb-6">
                                                <label class="block mb-2 font-medium">Meslek</label>
                                                <input type="text" name="guardian2_job" placeholder="örn: Memur"
                                                    disabled
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                                <div class="text-red-500 text-xs mt-2">
                                                    @error('guardian2_job')
                                            ...
                                            <div class="mb-6">
                                                <label class="block mb-2 font-medium">Telefon</label>
                                                <input type="tel" pattern="[0-9]*" max="11"
                                                    inputmode="numeric"
                                                    oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0,11)"
