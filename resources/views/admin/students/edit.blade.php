...
@section('content')
                        ...
                        <div class="py-10 px-5">
                            <div class="flex items-center justify-start gap-4 ">
                                <div class="flex items-center ps-4 border border-gray-300 rounded-lg w-1/4 bg-gray-50 cursor-pointer">
                                    <input id="bordered-radio-1" type="radio" name="registiration_type" value="1" class="w-4 h-4 text-blue-600 bg-white border-gray-300 focus:ring-blue-500  focus:ring-2 cursor-pointer" {{ $student->registration_type == '1' ? 'checked' : '' }}>
                                ...
                                <div class="flex items-center ps-4 border border-gray-300 rounded-lg w-1/4 bg-gray-50 cursor-pointer">
                                    <input id="bordered-radio-2" type="radio" name="registiration_type"  value="2" class="w-4 h-4 text-blue-600 bg-white border-gray-300 focus:ring-blue-500 focus:ring-2 cursor-pointer" {{ $student->registration_type == '2' ? 'checked' : '' }}>
                ...
                <div class="w-full bg-white rounded-lg border border-gray-200">
                 ...
                 <div class="py-10 px-5">
                     ...
                     <div>
                        ...
                        <div class="mb-6 mt-8">
                            <div class="flex items-center ps-4 border border-gray-300 rounded-lg w-1/4 bg-gray-50 cursor-pointer">
                                <input type="checkbox" id="guardian2_active" name="guardian2_active" value="1" {{ count($student->guardians ?? []) > 1 ? 'checked' : '' }} class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 focus:ring-2 cursor-pointer">
                        ...
                        <div id="guardian2_fields" class="grid grid-cols-4 gap-4">
                            ...
                            <div class="mb-6">
                                <label class="block mb-2 font-medium">Telefon</label>
                                <input type="text" name="guardian1_phone_2" placeholder="örn: 05551234545" disabled
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                    {{ count($student->guardians ?? []) > 1 ? '' : 'disabled' }}
    ...
    <div class="py-10 px-5">
        <div class="mb-0">
            <div class="flex items-center justify-start gap-4 ">
                                <div class="flex items-center ps-4 border border-gray-300 rounded-lg w-1/4 bg-gray-50 cursor-pointer">
                                    <input type="radio" name="has_allergy" value="1" id="has_allergy" {{ $student->has_allergy == '1' ? 'checked' : '' }}
                                ...
                                <div class="flex items-center ps-4 border border-gray-300 rounded-lg w-1/4 bg-gray-50 cursor-pointer">
                                    <input type="radio" name="has_allergy" value="2" id="no_allergy" {{ $student->has_allergy == '2' ? 'checked' : '' }}  
                                    class="w-4 h-4 text-blue-600 bg-white border-gray-300 focus:ring-blue-500  focus:ring-2 cursor-pointer">
...
{{-- Notes --}}
    ...
    <div class="py-5 px-5">
        <div class="mb-0">
                ...
                <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded cursor-pointer">Güncellemeri Kaydet</button>
            </form>
        </div>
