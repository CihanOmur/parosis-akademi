        ...
        <div class="space-y-5 sticky top-24 self-start">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200/50 dark:border-slate-700/50 overflow-hidden">
                ...
                <div class="p-5 space-y-3">
                    @if($teacher->image)
                        <div class="rounded-xl overflow-hidden border border-slate-200/50 dark:border-slate-700/50">
                            <img src="{{ asset($teacher->image) }}" alt="{{ $teacher->name }}" class="w-full h-auto object-cover">
                        </div>
                    @endif
