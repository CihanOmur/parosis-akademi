...
@section('title', ($globalSettings['seo']['meta_title'] ?? 'Parosis Akademi') . ' | Blog')
...
@section('content')
            ...
            @php
                $bcColor = $blogPageInfo?->breadcrumb_bg_color ?: '#FAF9F6';
                $bcImage = $blogPageInfo?->breadcrumb_bg_image ?? null;
