                                ...
                                <nav class="text-base font-medium uppercase">
                                    <ul class="flex justify-center">
                                        <li class="relative has-[a]:text-colorJasper has-[a]:after:text-colorCarbonGrey has-[a]:after:content-['/']">
                                            <a href="{{ route('front.home') }}">{{ $coursePageInfo?->getTranslation('breadcrumb_home', app()->getLocale()) ?: 'ANA SAYFA' }}</a>
                                        </li>
                                        <li class="relative has-[a]:text-colorJasper has-[a]:after:text-colorCarbonGrey has-[a]:after:content-['/']">
                                            <a href="{{ route('front.courses') }}">{{ $coursePageInfo?->getTranslation('breadcrumb_current', app()->getLocale()) ?: 'KURSLAR' }}</a>
                                        </li>
                                ...
                                <div class="jos">
                                    ...
                                    <div class="rich-text-area mt-11">
                                        ...
                                        <div class="mt-10 rounded-xl border border-colorPurpleBlue/10 bg-gradient-to-br from-[#F8F7FF] to-[#F1F0FB] p-6 lg:p-8">
                                            <div class="mb-5 flex items-center gap-3">
                                                ...
                                                <h5 class="text-xl font-bold">{{ $coursePageInfo?->getTranslation('detail_what_learn_title', app()->getLocale()) ?: 'Neler Öğreneceksiniz?' }}</h5>
                                            </div>
                                    ...
                                    <div class="mt-10 rounded-xl border border-colorBrightGold/20 bg-gradient-to-br from-[#FFFDF5] to-[#FFF9E6] p-6 lg:p-8">
                                        <div class="mb-5 flex items-center gap-3">
                                            ...
                                            <h5 class="text-xl font-bold">{{ $coursePageInfo?->getTranslation('detail_why_choose_title', app()->getLocale()) ?: 'Neden Bu Kurs?' }}</h5>
                                        </div>
                                ...
                                <aside class="jos">
                                    <ul class="grid grid-cols-1 gap-y-9">
                                        ...
                                        <li class="rounded-lg bg-[#f5f5f5] px-[30px] py-6">
                                            <h5 class="mb-7">{{ $coursePageInfo?->getTranslation('sidebar_info_title', app()->getLocale()) ?: 'Kurs Bilgileri:' }}</h5>
                                            <ul class="divide-y divide-[#E9E5DA]">
                                                ...
                                                <li class="flex items-center justify-between gap-x-5 py-4 first-of-type:pt-0 last-of-type:pb-0">
                                                    <span class="font-semibold text-[#4E5450]">{{ $coursePageInfo?->getTranslation('sidebar_price_label', app()->getLocale()) ?: 'Fiyat:' }}</span>
                                                    <span class="font-bold text-colorPurpleBlue">{{ $course->price }}</span>
                                                </li>
                                                @endif
                                                @if($course->instructor_name)
                                                <li class="flex items-center justify-between gap-x-5 py-4 first-of-type:pt-0 last-of-type:pb-0">
                                                    <span class="font-semibold text-[#4E5450]">{{ $coursePageInfo?->getTranslation('sidebar_instructor_label', app()->getLocale()) ?: 'Eğitmen:' }}</span>
                                                    <span class="font-normal">{{ $course->instructor_name }}</span>
                                                </li>
                                                @endif
                                                <li class="flex items-center justify-between gap-x-5 py-4 first-of-type:pt-0 last-of-type:pb-0">
                                                    <span class="font-semibold text-[#4E5450]">{{ $coursePageInfo?->getTranslation('sidebar_certification_label', app()->getLocale()) ?: 'Sertifika:' }}</span>
                                                    <span class="font-normal">{{ $course->has_certification ? 'Evet' : 'Hayır' }}</span>
                                                </li>
                                                @if($course->lesson_count)
                                                <li class="flex items-center justify-between gap-x-5 py-4 first-of-type:pt-0 last-of-type:pb-0">
                                                    <span class="font-semibold text-[#4E5450]">{{ $coursePageInfo?->getTranslation('sidebar_lessons_label', app()->getLocale()) ?: 'Dersler:' }}</span>
                                                    <span class="font-normal">{{ $course->lesson_count }}</span>
                                                </li>
                                                @endif
                                                @if($course->duration)
                                                <li class="flex items-center justify-between gap-x-5 py-4 first-of-type:pt-0 last-of-type:pb-0">
                                                    <span class="font-semibold text-[#4E5450]">{{ $coursePageInfo?->getTranslation('sidebar_duration_label', app()->getLocale()) ?: 'Süre:' }}</span>
                                                    <span class="font-normal">{{ $course->duration }}</span>
                                                </li>
                                                @endif
                                                @if($course->language)
                                                <li class="flex items-center justify-between gap-x-5 py-4 first-of-type:pt-0 last-of-type:pb-0">
                                                    <span class="font-semibold text-[#4E5450]">{{ $coursePageInfo?->getTranslation('sidebar_language_label', app()->getLocale()) ?: 'Dil:' }}</span>
                                                    <span class="font-normal">{{ $course->language }}</span>
                                                </li>
                                                @endif
                                                @if($course->student_count)
                                                <li class="flex items-center justify-between gap-x-5 py-4 first-of-type:pt-0 last-of-type:pb-0">
                                                    <span class="font-semibold text-[#4E5450]">{{ $coursePageInfo?->getTranslation('sidebar_students_label', app()->getLocale()) ?: 'Öğrenciler:' }}</span>
                                        ...
                                        <!-- Contact Us -->
                                        <li class="rounded-lg bg-[#f5f5f5] px-[30px] py-6">
                                            <h5 class="mb-7">{{ $coursePageInfo?->getTranslation('sidebar_contact_title', app()->getLocale()) ?: 'İletişim' }}</h5>
                                            <ul class="flex flex-col gap-y-3">
                                                ...
                                                <li class="inline-flex gap-x-6">
                                                    ...
                                                    <div class="flex-1">
                                                        <span class="block">{{ $coursePageInfo->getTranslation('sidebar_contact_phone_label', app()->getLocale()) ?: '7/24 Destek' }}</span>
                                                ...
                                                <li class="inline-flex gap-x-6">
                                                    ...
                                                    <div class="flex-1">
                                                        <span class="block">{{ $coursePageInfo->getTranslation('sidebar_contact_email_label', app()->getLocale()) ?: 'Mesaj Gönderin' }}</span>
                                                ...
                                                <li class="inline-flex gap-x-6">
                                                    ...
                                                    <div class="flex-1">
                                                        <span class="block">{{ $coursePageInfo->getTranslation('sidebar_contact_address_label', app()->getLocale()) ?: 'Adresimiz' }}</span>
                                                        <address class="font-title text-xl not-italic text-colorBlackPearl">
                                                            {{ $coursePageInfo->getTranslation('sidebar_contact_address', app()->getLocale()) }}
                                                        </address>
                                                    </div>
                                                </li>
                                                @endif
