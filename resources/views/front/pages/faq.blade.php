                                    ...
                                    <form action="{{ route('front.contact.send') }}" method="post">
                                        ...
                                        <div class="grid grid-cols-1 gap-y-10">
                                            ...
                                            <div class="mt-10 grid grid-cols-1 gap-9">
                                                <!-- Single Input Item -->
                                                <div class="w-full">
                                                    <textarea placeholder="{{ $faqPageInfo?->getTranslation('form_message_placeholder', app()->getLocale()) ?: 'Size nasıl yardımcı olabiliriz?' }}" name="message" class="w-full border-b border-colorBlackPearl/25 outline-none transition-all placeholder:text-[#5F5D5D] focus-visible:border-colorBlackPearl focus-visible:text-colorBlackPearl" required></textarea>
                                                </div>
                                                <!-- Single Input Item -->
                                            </div>
                                            <!-- Form Group -->
