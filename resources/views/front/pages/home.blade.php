            ...
            <section class="section-hero overflow-hidden">
                    ...
                    @if($slides->count() === 1)
                        ...
                        <div class="relative z-10 overflow-hidden bg-cover bg-center bg-no-repeat h-[calc(100svh-70px)] md:h-[calc(100vh-140px)]"
                            ...
                            <div class="grid grid-cols-1 items-end gap-2 px-5 pb-2 pt-6 md:gap-6 md:py-16 lg:grid-cols-2 lg:gap-0 lg:px-0 lg:py-0 lg:pl-20 xxxl:pl-32 xxxxl:pl-[250px] h-full">
                                <div class="py-2 lg:py-16 xxl:py-24">
                                    <h1 class="mb-2 md:mb-[30px]">
                                        {!! nl2br(e(str_replace(
                                    ...
                                    @if($slide->description)
                                        <p class="mb-4 md:mb-10 max-w-[400px] xl:max-w-[474px]">
                                            {{ $slide->description }}
                                        </p>
                                    @endif
