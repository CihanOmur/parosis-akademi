...
@section('title', $globalSettings['seo']['meta_title'] ?? 'Parosis Akademi')
...
@endphp
            ...
            <section class="section-hero overflow-hidden">
                    ...
                    @if($slides->count() === 1)
                        ...
                        <div class="relative z-10 overflow-hidden bg-cover bg-center bg-no-repeat h-[calc(100svh-70px)] md:h-[calc(100vh-140px)]"
                            ...
                            <div class="grid grid-cols-1 items-end gap-6 px-5 pb-0 pt-8 md:py-16 lg:grid-cols-2 lg:gap-0 lg:px-0 lg:py-0 lg:pl-20 xxxl:pl-32 xxxxl:pl-[250px] h-full overflow-hidden">
                                ...
                                @if($slide->image)
                                    <div class="relative flex items-end justify-center overflow-hidden h-auto max-h-[40vh] md:h-full md:max-h-none">
                                        ...
                                        <div class="jos absolute bottom-0 left-1/2 -z-10 h-[180px] w-[180px] md:h-[300px] md:w-[300px] -translate-x-1/2 rounded-[50%] bg-gradient-to-t from-[#D7E1D8] to-white lg:-bottom-28 xl:h-[400px] xl:w-[400px] xxl:h-[550px] xxl:w-[550px]" data-jos_animation="zoom-in-up"></div>
                                    </div>
                                @endif
                            </div>
                        </div>
                    @else
                        ...
                        <div class="relative">
                            <div class="swiper hero-slider relative z-10 overflow-hidden h-[calc(100svh-70px)] md:h-[calc(100vh-140px)]">
                                                ...
                                                <div class="grid grid-cols-1 items-end gap-6 px-5 pb-0 pt-8 md:py-16 lg:grid-cols-2 lg:gap-0 lg:px-0 lg:py-0 lg:pl-20 xxxl:pl-32 xxxxl:pl-[250px] h-full overflow-hidden">
                                                    ...
                                                    @if($slide->image)
                                                        <div class="relative flex items-end justify-center overflow-hidden h-auto max-h-[40vh] md:h-full md:max-h-none">
                                                            ...
                                                            <div class="absolute bottom-0 left-1/2 -z-10 h-[180px] w-[180px] md:h-[300px] md:w-[300px] -translate-x-1/2 rounded-[50%] bg-gradient-to-t from-[#D7E1D8] to-white lg:-bottom-28 xl:h-[400px] xl:w-[400px] xxl:h-[550px] xxl:w-[550px]"></div>
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                            ...
                            {{-- Sol/Sag oklar — sadece desktop (md+) --}}
                            <button class="hero-slider-prev hidden md:flex absolute left-4 lg:left-8 top-1/2 z-30 -translate-y-1/2 w-12 h-12 rounded-full backdrop-blur-sm items-center justify-center transition-all duration-300 group" style="background:rgba(84,62,232,0.2);" onmouseover="this.style.background='rgba(84,62,232,0.4)'" onmouseout="this.style.background='rgba(84,62,232,0.2)'">
                            ...
                            <button class="hero-slider-next hidden md:flex absolute right-4 lg:right-8 top-1/2 z-30 -translate-y-1/2 w-12 h-12 rounded-full backdrop-blur-sm items-center justify-center transition-all duration-300 group" style="background:rgba(84,62,232,0.2);" onmouseover="this.style.background='rgba(84,62,232,0.4)'" onmouseout="this.style.background='rgba(84,62,232,0.2)'">
            ...
            <section class="section-course-category">
                ...
                <div class="section-space">
                    ...
                    <div class="container">
                        ...
                        <!-- Course Category List (Desktop grid) -->
                        <ul class="hidden md:grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                            @foreach($courseCategories as $category)
                            <li class="jos">
                                @include('front.partials.category-card', ['category' => $category])
                            </li>
                            @endforeach
                        </ul>
                        <!-- Course Category List -->

                        <!-- Course Category Carousel (Mobile only, 2 rows) -->
                        <div class="md:hidden">
                            ...
                            <div class="category-swiper-pagination flex justify-center gap-2 mt-6"></div>
                        </div>
                ...
                <div class="bg-white">
                    ...
                    <div class="section-space">
                        ...
                        <div class="container">
                            ...
                            <div class="md:hidden">
                                <div class="swiper course-swiper !overflow-visible">
                                    <div class="swiper-wrapper">
                                        @foreach($courses as $course)
                                ...
                                <div class="course-swiper-pagination flex justify-center gap-2 mt-6"></div>
                            </div>
                            <!-- Course Carousel -->
                        </div>
                        <!-- Section Container -->
            ...
            <section class="section-blog">
                <!-- Section Background -->
                <div class="relative z-10 overflow-hidden bg-white pb-16 lg:pb-20">
                    <!-- Section Space -->
                    <div class="section-space">
                        <!-- Section Container -->
                        <div class="container">
...
<script>
    ...
    // Course carousel (sadece mobilde aktif — md+ desktop grid gösteriyor)
    ...
    // Category carousel (mobilde 2 sira halinde grid + swipe)
