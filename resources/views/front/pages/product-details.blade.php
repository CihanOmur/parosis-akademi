...
@section('title', ($globalSettings['seo']['meta_title'] ?? 'Parosis Akademi') . ' | ' . e($product->name))
                        ...
                        <div class="container">
                            ...
                            <div class="grid grid-cols-1 items-start gap-10 lg:grid-cols-2 lg:gap-16 xl:gap-20">
                                ...
                                <div class="jos" data-jos_animation="fade-left">
                                    ...
                                    <form action="{{ route('front.cart.add') }}" method="POST" id="add-to-cart-form" onsubmit="return addToCartAjax(event)">
                                        ...
                                        <div class="flex flex-wrap items-center gap-4">
                                            ...
                                            <button type="submit"
                                                    ...
                                                    class="inline-flex items-center justify-center gap-2.5 whitespace-nowrap rounded-full bg-colorPurpleBlue px-8 py-4 text-base font-medium text-white transition hover:brightness-110 hover:shadow-lg flex-1 sm:flex-none sm:min-w-[220px] disabled:cursor-not-allowed disabled:opacity-50">
                                    ...
                                    <div class="mb-6 flex items-center gap-3 rounded-xl bg-emerald-50 border border-emerald-200 p-4">
                                        <div class="flex h-10 w-10 items-center justify-center rounded-full bg-emerald-500 text-white flex-shrink-0">
                                            <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 0 1-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 0 0-3.213-9.193 2.056 2.056 0 0 0-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 0 0-10.026 0 1.106 1.106 0 0 0-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12"/>
                                            </svg>
                                        </div>
                                        <div class="flex-1">
                                            <div class="font-semibold text-emerald-900">Ücretsiz Kargo</div>
                                            <div class="text-sm text-emerald-700">Bu ürün için kargo ücreti yok.</div>
                                        </div>
                                    </div>
                                    @endif
