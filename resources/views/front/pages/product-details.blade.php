                                    ...
                                    <form action="{{ route('front.cart.add') }}" method="POST" id="add-to-cart-form" onsubmit="return addToCartAjax(event)">
                                        ...
                                        <div class="flex flex-wrap items-center gap-4">
                                            ...
                                            <button type="submit"
                                                    ...
                                                    class="btn btn-primary inline-flex items-center justify-center gap-2 whitespace-nowrap flex-1 disabled:cursor-not-allowed disabled:opacity-50 sm:flex-none sm:min-w-[200px]">
