                                ...
                                <div class="jos" data-jos_animation="fade-left">
                                    ...
                                    <form action="{{ route('front.cart.add') }}" method="POST" id="add-to-cart-form" onsubmit="return addToCartAjax(event)">
                                        ...
                                        <div class="flex flex-wrap items-center gap-4">
                                            ...
                                            <!-- Add to Cart Button (kartlardaki gibi is-icon) -->
                                            <button type="submit"
                                                    id="add-to-cart-btn"
                                                    @if($product->variants && $product->variants->count()) disabled @endif
                                                    class="btn btn-primary is-icon group flex-shrink-0 whitespace-nowrap min-w-[280px] disabled:cursor-not-allowed disabled:opacity-50">
